          ...
          <b-col xs="12">
            <b-form-group label="Nome:" label-for="article-name">
              <b-form-input id="article-name" type="text"
                ...
                v-model="article.name" required placeholder="Informe o Nome do Artigo">
              </b-form-input>
            </b-form-group>
            <b-form-group label="Descrição:" label-for="article-description">
              <b-form-input id="article-description" type="text"
                :readonly="mode === 'remove'" 
                v-model="article.description" required placeholder="Informe o Nome do Artigo">
              </b-form-input>
            </b-form-group>
            <b-form-group v-show="mode === 'save'" label="Imagem (URL):" label-for="article-imageUrl">
              <b-form-input id="article-imageUrl" type="text"
                :readonly="mode === 'remove'" 
                v-model="article.imageUrl" required placeholder="Informe a URL da Imagem...">
              </b-form-input>
            </b-form-group>
          </b-col>
        </b-row>
